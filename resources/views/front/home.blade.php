<!-- this is the home content page no header or footer 
but when it extends the layout.main which contain 
the header and the footer and then -->


<!-- 

the part I am writing right now should be in every page otherwise
the user variable of the authentification won't be usefull 

Anyway for the time being I am not going to do any trouble with 
this session stuff 
...
@extends('layout.main')
<!-- I think this extends is just to establish a relationship between the home and the main page -->
@section('content')
<!-- here we need to put the content ma3neha wist il page ech bech nraw -->
	<!-- banner -->
	<div class="banner">
		<div class="container">
			<h3>Electrostar Store, <span>Special Offers</span></h3>
		</div>
	</div>
	<!-- //banner --> 
	<!-- banner-bottom -->
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>380 dinars</span> <i class="item_price">350 dinars</i></p>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>330 dinars</span> <i class="item_price">302 dinars</i></p>
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									...
									<div class="simpleCart_shelfItem">
										<p><span>dinars 250</span> <i class="item_price">245 dinars</i></p>
										<form action="#" method="post">
											<input type="hidden" name="cmd" value="_cart" />
											<input type="hidden" name="add" value="1" /> 
	...
	<div class="banner-bottom1">
		<div class="agileinfo_banner_bottom1_grids">
			<div class="col-md-7 agileinfo_banner_bottom1_grid_left">
				<h3 style="font-weight: 900;">Quoi de neuf !! <span>20% <i>Remise</i></span></h3>
				
				<a href="products.html" style="background-position-x: 220px;">Achetez maintenant </a>
			
			</div>
			<div class="col-md-5 agileinfo_banner_bottom1_grid_right">
				<h4>Bonnes affaires</h4>
				...
				<div class="col-md-7 w3agile_special_deals_grid_left">
					<div class="w3agile_special_deals_grid_left_grid">
						...
						<div class="w3agile_special_deals_grid_left_grid_pos">
							<h4>Nous offrons <span>Les meilleurs produits</span></h4>
						</div>
					</div>
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										...
										<p>Je suis ravis des services d'Electrostar</p>
										<h4>Fatma</h4>
									</div>
								</div>
							</article>
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>520 dinars</span> <i class="item_price">500 dinars</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>380 dinars</span> <i class="item_price">370 dinars</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>150 dinars</span> <i class="item_price">100 dinars</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							<p><span>280 dinars</span> <i class="item_price">250 dinars</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
								<input type="hidden" name="w3ls_item" value="Induction Stove"> 
